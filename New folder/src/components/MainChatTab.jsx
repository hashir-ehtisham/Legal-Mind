...
export default function MainChatTab({
  ...
  // Trigger loading skeleton on active case change to demonstrate loading capability
  useEffect(() => {
...
We recommend engaging a local advocate to evaluate your case options. Let's find a lawyer who handles these matters.`;
  ...
  const showFinderCta = !isLoading && activeChats.length >= 3 && activeChats[activeChats.length - 1].sender === 'assistant';
